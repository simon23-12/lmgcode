...
**Type:** HTML, JS, CSS  
**Purpose:** Browser-basierter Coding-Assistent für Informatikschüler (Klassen 5–10) am Leibniz-Montessori-Gymnasium Düsseldorf — ähnlich wie Claude Code / Codex im Browser.  
...
| Kimi | Kimi → Step → Gemini Flash Lite → Qwen |
